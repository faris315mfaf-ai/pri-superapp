...
echo "         node /opt/pri-superapp/sumber/alat/postiz-rekam-kontrak.mjs --kirim-uji"
echo "     Jangan pindahkan anggota mana pun sebelum laporan itu bersih."
echo "  4. Isi POSTIZ_URL dan POSTIZ_API_KEY di /opt/pri-superapp/aplikasi/env.txt,"
