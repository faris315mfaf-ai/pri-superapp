...
//   • skin      : skin eksklusif seasonal (robot-skin.tsx) — menggantikan slot
//                 kepala/badan/punggung/tangan; mata/leher/aura tetap tampil
//   • warna     : warna custom #RRGGBB (palet utama diturunkan dari sini);
//                 bila kosong, skin memakai warna bawaannya
...
type Props = {
  ...
  menyapa?: boolean;
  makan?: boolean;
  /** Kode skin eksklusif (lib/pet KATALOG_SKIN) atau null. */
  skin?: string | null;
  /** Warna custom #RRGGBB atau null (bawaan). */
  warna?: string | null;
  className?: string;
  style?: CSSProperties;
};
...
export function RobotSvg({
  ...
  const sk = skin ? skinDariKode(skin) : undefined;
  const warnaAktif = warna ?? sk?.warnaUtama ?? null;
  const p = warnaAktif ? paletDenganWarna(jenis, warnaAktif) : PALET[jenis];
    ...
    switch (spKaki) {
      ...
      case "kaki_roket":
        return (
          <g>
            <polygon
              points="82,206 118,206 108,234 92,234"
              fill="#6B7280"
              stroke="#374151"
              strokeWidth="2"
            />
      ...
      default:
        return (
          <g>
            ...
            />
            <path
              d={wanita ? "M56 34 Q80 20 110 26" : "M52 34 Q80 22 112 26"}
              fill="none"
              stroke="#FFFFFF"
              strokeWidth="6"
              strokeLinecap="round"
  ...
  return (
    ...
    >
      <defs>
        ...
        <linearGradient id={`${id}-emas`} x1="0" y1="0" x2="0" y2="1">
          <stop offset="0" stopColor="#FDE68A" />
          <stop offset="0.5" stopColor="#F59E0B" />
          <stop offset="1" stopColor="#B45309" />
        </linearGradient>
        <radialGradient id={`${id}-es`} cx="0.5" cy="0.5" r="0.5">
          <stop offset="0" stopColor="#E0F2FE" stopOpacity="0.7" />
          <stop offset="1" stopColor="#38BDF8" stopOpacity="0" />
        </radialGradient>
        <radialGradient id={`${id}-api-aura`} cx="0.5" cy="0.5" r="0.5">
          <stop offset="0" stopColor="#FDBA74" stopOpacity="0.55" />
          <stop offset="0.7" stopColor="#F97316" stopOpacity="0.2" />
          <stop offset="1" stopColor="#F97316" stopOpacity="0" />
        </radialGradient>
        <radialGradient id={`${id}-cahaya`} cx="0.5" cy="0.5" r="0.5">
          <stop offset="0" stopColor="#FFFFFF" stopOpacity="0.8" />
          <stop offset="0.6" stopColor="#FDE68A" stopOpacity="0.25" />
      ...
      <g className={kelasTubuh}>
        ...
        {punggung === "sayap" ? (
          <g>
            <path
              d="M58 134 Q10 108 6 162 Q30 150 34 178 Q48 172 60 192 Z"
              fill="#F8FAFC"
              stroke="#CBD5E1"
              strokeWidth="2"
            />
            <path
              d="M142 134 Q190 108 194 162 Q170 150 166 178 Q152 172 140 192 Z"
              fill="#F8FAFC"
              stroke="#CBD5E1"
              strokeWidth="2"
            />
        ...
        {badan === "jubah" ? (
          <g>
            <path
              d="M62 118 Q40 190 52 234 L100 216 L148 234 Q160 190 138 118 Z"
              fill="#7C3AED"
              opacity="0.95"
            />
        ...
        {wanita ? (
          <path
            d="M100 162 l-6 -5.5 a3.5 3.5 0 1 1 6 -4 a3.5 3.5 0 1 1 6 4 z"
            fill="#FFFFFF"
            opacity="0.95"
          />
        ) : (
          <polygon
            points="100,149 102,154 107,154 103,157 104.5,162 100,159 95.5,162 97,157 93,154 98,154"
            fill="#FFFFFF"
            opacity="0.95"
          />
        )}
        ...
        {tangan === "mic" ? (
          <g>
            ...
            />
            <path
              d="M152 136 H166 M152 141 H166 M152 146 H166"
              stroke="#9CA3AF"
              strokeWidth="1.5"
            />
          </g>
        ...
        {makan ? (
          <ellipse
            ...
            fill={p.mata}
            opacity="0.9"
            className={kelas("pet-makan-mulut")}
          />
        ) : (
          <g fill="none" stroke={p.mata} strokeWidth="3" strokeLinecap="round">
            ...
            {suasana === "kotor" ? (
              <path d="M80 82 q6 -6 12 0 t12 0 t12 0" />
            ) : null}
            {suasana === "tidur" ? <path d="M90 84 H110" /> : null}
          </g>
        )}
        {!makan && suasana === "lapar" ? (
          <ellipse cx="100" cy="82" rx="9" ry="7" fill={p.mata} opacity="0.9" />
        ) : null}
        {suasana === "kotor" ? (
        ...
        {!tidur && vitalitas === "lemas" ? (
          <path
            d="M150 40 q6 10 0 14 q-6 -4 0 -14 z"
            fill="#60A5FA"
            opacity="0.85"
          />
        ) : null}
        ...
        {spKepala !== "kepala_tv" ? (
          <g>
            <line
              ...
              x2="100"
              y2="-4"
              stroke={wanita ? p.utamaGelap : p.aksen}
              strokeWidth="4"
              strokeLinecap="round"
            />
            <circle
        ...
        {kepala === "topi_wisuda" ? (
          <g>
            ...
            <polygon
              points="100,-18 170,10 100,26 30,10"
              fill="#111827"
              stroke="#374151"
              strokeWidth="1.5"
            />
        ...
        {kepala === "mahkota" ? (
          <g>
            <polygon
              points="62,20 62,-10 78,6 100,-22 122,6 138,-10 138,20"
              fill="#F59E0B"
              stroke="#B45309"
              strokeWidth="2"
              strokeLinejoin="round"
